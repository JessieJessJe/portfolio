...
const RainbowText = ({ text } : RainbowTextProps): JSX.Element => {
  const colors = [
    'text-blue-500',
    'text-green-500',
    'text-red-500',
  ...
  const letters = text.split('').map((char, index) => (
    <span key={uuidv4()} className={`${colors[index % colors.length]} font-highlight`}>
      {char}
    </span>
  ))
    ...
    <div className="font-header flex flex-col p-6 bg-black max-md:px-5">
          ...
          <div className='flex flex-col ml-5 w-[33%] max-md:ml-0 max-md:w-full'>
            <div className='flex flex-col justify-center px-6 py-16 text-slate-100 max-md:px-5 max-md:max-w-full'>
              ...
              <div className="mt-12 text-xl max-md:max-w-full">
                <a
                  href="https://jiahuihan.notion.site/Designing-for-the-almost-first-InsurTech-SaaS-d18a1acbf6a64960bb86643ab94e8fc1?pvs=4"
                  className="text-xl max-md:max-w-full hover:underline"
                  target="_blank"
      ...
      <div className="mt-20 max-md:mt-10 max-md:max-w-full">
        <div className="flex gap-5 max-md:flex-col max-md:gap-0">
          ...
          <a href="https://jessiejessje.github.io/nyc-conaming/" target="_blank" rel="noopener noreferrer">
            <img
              loading="lazy"
              src={Work1.src}
          ...
          <a href="https://github.com/JessieJessJe/major-studio-1/tree/master/quantitative_data" target="_blank" rel="noopener noreferrer">
            <img
              loading="lazy"
              src={Work2.src}
              className="w-full aspect-[1.75] max-md:mt-6 max-md:max-w-full" />
      ...
      <div className="mt-20 max-md:mt-0 max-md:max-w-full">
        <div className="flex gap-5 max-md:flex-col max-md:gap-0">
          ...
          <a href="https://thegreeneyl.com/liquid-archive" target="_blank" rel="noopener noreferrer">
            <img
              loading="lazy"
              src={Work3.src}
