...
export default function Home() {
  return (
    <div className="font-header flex flex-col p-6 bg-black max-md:px-5">
      <div className="flex gap-2.5 justify-between w-full text-2xl text-white font-[274] max-md:flex-wrap max-md:max-w-full">
        <div>Jessie Han</div>
      ...
      <div className="mt-48 rounded-3xl border border-white border-solid max-md:mt-10 max-md:max-w-full">
        <div className="flex gap-5 max-md:flex-col max-md:gap-0">
          ...
          <div className="flex flex-col ml-5 w-[33%] max-md:ml-0 max-md:w-full">
            <div className="flex flex-col justify-center px-6 pt-16 text-white max-md:px-5 max-md:max-w-full">
      ...
      <div className="font-title self-start mt-44 text-4xl text-white max-md:mt-10 max-md:max-w-full">
        Other Works / Selected Projects
      </div>
      <div className="font-body self-start mt-2.5 text-xl text-white max-md:max-w-full">
